...
public class LinkedQueueTester {
    ...
    public static void main(String args[]){
        ...
        printQueue(queue.iterator());



        //Test #7
        System.out.println("\nTest 7: Check the contains() method.");
        System.out.println("nCurrent contents:");
        printQueue(queue.iterator());
    ...
    public static void printQueue(Iterator queueIterator){
       int counter = 1;
       while(queueIterator.hasNext()){
           System.out.println(counter + ". " + ((DummyClass)queueIterator.next()).getValue());
           counter++;
       }
    }

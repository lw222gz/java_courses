package lw222gz_assign1.exercise_4;
...
public class HighLow {
    ...
    private static void startGame(){
        ...
        //The assignment says that the secretNumber should be odd, I find this to be a
        //weird mechanic so I've commented out the code that would always make sure that the number will be odd.
        //If the number is even, then 1 is removed to make it odd.
        /*if(secretNumber % 2 == 0){
            secretNumber -= 1;
        }*/
